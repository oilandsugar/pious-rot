...
[[DND]]
## The Knot of the Abhorrent 
Melee Weapon (Magic, Flail)
Damage: 2D4
Damage Type: Buldgeoning
Item Rarity: Legendary
Properties: Reach, Heavy
Range: 10ft
When you hit a creature with a melee weapon attack with The Fist of the Abhorrent the target must make a DC 15 constitution saving throw, if it fails roll a 1D4. 
On a 1, the target’s left arm turns to slime until the start of its next turn, it drops anything it is holding in that hand
On a 2, the target’s right arm turns to slime until the start of its next turn, it drops anything it is holding in that hand
On a 3, the target’s legs turn to slime until the start of its next turn and the target goes prone.
On a 4, the target’s neck turns to slime until the start of its next turn, the target has disadvantage on all attacks until the start of it’s next turn. 
